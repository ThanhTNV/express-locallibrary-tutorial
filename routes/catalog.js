...
// GET request to delete Book (FORM).
router.get("/book/:id/delete", book_controller.book_delete_get);

// POST request to delete Book.
router.post("/book/:id/delete", book_controller.book_delete_post);

// GET request to update Book (FORM).
...
// GET request for creating Author (FORM).
...
// GET request to delete Author (FORM).
router.get("/author/:id/delete", author_controller.author_delete_get);

// POST request to delete Author.
router.post("/author/:id/delete", author_controller.author_delete_post);

// GET request to update Author (FORM).
...
// GET request to delete Genre (FORM).
router.get("/genre/:id/delete", genre_controller.genre_delete_get);

// POST request to delete Genre.
router.post("/genre/:id/delete", genre_controller.genre_delete_post);

// GET request to update Genre (FORM).
...
// GET request to delete BookInstance (FORM).
router.get(
...
// GET request to update BookInstance (FORM).
router.get(
